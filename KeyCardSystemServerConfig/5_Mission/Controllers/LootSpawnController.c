class LootSpawnController : LootSpawnControllerBase
{
...
{
    private ref static LootSpawnManager	    m_Instance;

    void LootSpawnManager()
    {
        m_Instance = this;
    }

    static LootSpawnManager GetInstance()
	{
		return m_Instance;
	}
    ...
    void T3Door( EntityAI crate )
    {
        ...
        Print("LootSpawnManager::T3Door( crate )");
